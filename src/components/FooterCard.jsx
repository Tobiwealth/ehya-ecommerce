	...
	return (
		<div className="bg-yelloww flex justify-center items-center pt-8 lg:pl-36 lg:pr-10">
			<div className="flex flex-col-reverse lg:flex-row justify-center items-center gap-10 md:gap-16">
				<div>
				    <img className="w-[17.5rem] h-[12.1rem] md:w-[25.13rem] md:h-[15.63rem] lg:h-[22.13rem] lg:-mb-4" src="https://lphkvolpvequyswccgnt.supabase.co/storage/v1/object/public/image/HeroImage.png" alt="footer"/>
				</div>
				<div className="lg:flex lg:flex-col items-start">
					...
					<div className="flex justify-center items-center gap-6 lg:pl-16">
						<img className="w-[7rem] md:w-[10rem] lg:w-[10.8rem]" src="https://lphkvolpvequyswccgnt.supabase.co/storage/v1/object/public/image/Object.png" alt="icon"/>
						<img className="w-[7rem] md:w-[10rem] lg:w-[10.8rem]" src="https://lphkvolpvequyswccgnt.supabase.co/storage/v1/object/public/image/Object1.png" alt="icon" />
					</div>
				</div>
			</div>
		</div>
