					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 lg:gap-0 place-items-center rounded-lg p-8 md:p-4 md:pl-0 md:pr-0 bg-white mb-4">
						<div className="flex flex-col justify-center items-center gap-6 p-8 mt-6 md:mt-0 md:p-4 pt-6 pb-6 border-b-2 md:border-b-0 md:border-r-2 w-[16.4rem] h-[20.6rem]">
							<motion.img 
							    ...
							    className="min-w-[7rem] min-h-[7rem] max-w-[7.5rem] max-h-[7.5rem] mb-auto" src={`${product[2]?.imageUrl}`} alt="card 1"
							/>
							<div>
								<h2 className="text-hk-grotesk font-bold text-blackk text-lg lg:text-xl">Asus Zenbook Pro 13”</h2>
								<p className="text-open-sans font-normal text-greyy text-sm md:text-base ">{product[2]?.description}</p>
							</div>
							<p className="text-open-sans font-semibold text-green-button text-xl mt-auto">${product[2]?.price}</p>
						</div>
						<div className="flex flex-col justify-center items-center gap-6 p-8 mt-8 md:mt-0 md:p-4 pt-6 pb-6 border-b-2 md:border-b-0 lg:border-r-2 w-[16.4rem] h-[20.6rem]">
							<motion.img 
							    initial={{ opacity: 0.2 }}
                                whileInView={{ opacity: 1, transition:{delay:0.5, duration:1.5} }}
							    className="min-w-[7rem] min-h-[7rem] max-w-[7.5rem] max-h-[7.5rem] mb-auto" src={`${product[5]?.imageUrl}`} alt="card 1"
							/>
							<div>
								<h2 className="text-hk-grotesk font-bold text-blackk text-lg lg:text-xl">Modena Juice Blender</h2>
								<p className="text-open-sans font-normal text-greyy text-sm md:text-base ">{product[5]?.description}</p>
							</div>
							<p className="text-open-sans font-semibold text-green-button text-xl mt-auto">${product[5]?.price}</p>
						</div>
						<div className="flex flex-col justify-center items-center gap-6 mt-8 md:mt-0 p-8 md:p-4 pt-6 pb-6 border-b-2 md:border-b-0 md:border-r-2 lg:border-0 xl:border-r-2 w-[16.4rem] h-[20.6rem]">
							<motion.img 
							    initial={{ opacity: 0.2 }}
                                whileInView={{ opacity: 1, transition:{delay:0.5, duration:1.5} }}
							    className="min-w-[7rem] min-h-[7rem] max-w-[7.5rem] max-h-[7.5rem] mb-auto" src={`${product[8]?.imageUrl}`} alt="card 1"
							/>
							<div>
								<h2 className="text-hk-grotesk font-bold text-blackk text-lg lg:text-xl">{product[8]?.name}</h2>
								<p className="text-open-sans font-normal text-greyy text-sm md:text-base ">{product[8]?.description}</p>
							</div>
							<p className="text-open-sans font-semibold text-green-button text-xl mt-auto">${product[8]?.price}</p>
						</div>
						<div className="flex flex-col justify-center items-center gap-6 mt-8 md:mt-0 p-8 md:p-4 pt-6 pb-6 w-[16.4rem] h-[20.6rem]">
							<motion.img
							    initial={{ opacity: 0.2 }}
                                whileInView={{ opacity: 1, transition:{delay:0.5, duration:1.5} }} 
							    className="min-w-[7rem] min-h-[7rem] max-w-[7.5rem] max-h-[7.5rem] mb-auto" src={`${product[7]?.imageUrl}`} alt="card 1"
					        />
							<div>
								<h2 className="text-hk-grotesk font-bold text-blackk text-lg lg:text-xl">iPad Pro 2018</h2>
								<p className="text-open-sans font-normal text-greyy text-sm md:text-base ">{product[7]?.description}</p>
							</div>
							<p className="text-open-sans font-semibold text-green-button text-xl mt-auto">${product[7]?.price}</p>
						</div>
					</div>
